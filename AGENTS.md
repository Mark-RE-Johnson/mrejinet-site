...
- Current repo language mix does not justify `jcodemunch` or `cclsp` as first-line tools. Reach for them only if the repo later adds supported JS/TS/Python source that needs symbol-aware navigation.
